  ...
  if (req.method === 'POST' && req.url === '/download') {
    ...
    req.on('end', async () => {
      try {
        ...
        const paths = {
          nifty_5min:      (d) => `/v2/historical-candle/NSE_INDEX%7CNifty%2050/5minute/${d}/${d}`,
          nifty_15min:     (d) => `/v2/historical-candle/NSE_INDEX%7CNifty%2050/15minute/${d}/${d}`,
          nifty_30min:     (d) => `/v2/historical-candle/NSE_INDEX%7CNifty%2050/30minute/${d}/${d}`,
          banknifty_5min:  (d) => `/v2/historical-candle/NSE_INDEX%7CNifty%20Bank/5minute/${d}/${d}`,
          banknifty_15min: (d) => `/v2/historical-candle/NSE_INDEX%7CNifty%20Bank/15minute/${d}/${d}`,
        };
